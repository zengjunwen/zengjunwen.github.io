...
const config = {
  ...
  url: 'https://zengjunwen.github.io/',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        //       {
        //         label: 'GitHub',
        //         href: 'zengjunwen.github.io-master/index.html',
        //       },
        //     ],
        //   },
        // ],
        copyright: `Copyright © Jon ${new Date().getFullYear()}`,
      },
      prism: {
      ...
      routes: [
        {
          path: '/example',
          component: '@site/static/zengjunwen.github.io-master/index.html',
        },
      ],
    }),
};
